...
print(f"Dang chay AI tren: {device}") # Đã bỏ dấu tiếng Việt

# Tải các từ điển (Encoder)
print("Dang nap Label Encoders...") # Đã bỏ dấu tiếng Việt
