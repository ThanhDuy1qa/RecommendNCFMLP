                ...
                <div className="flex justify-between items-center mt-5 pt-4 border-t border-slate-200">
                  ...
                  <div className="flex gap-3">
                    ...
                    {(order.status === 'Đang giao hàng' || order.status === 'Đang giao') && (
                      <>
                        <button 
                          onClick={() => handleReportNotReceived(order._id)}
                          className="text-sm font-bold bg-wDDhite hover:bg-rose-50 text-rose-600 border border-rose-300 px-4 py-2.5 rounded-xl transition-all shadow-sm"
                        >
